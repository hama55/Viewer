		...
		TreeItem_Imp
{
	...
	private Node create_JavafxNode()
	{
		...
		mathmatic.Mathmatic.calc_vector_between_point_point_unit(this.m_point_start.ask_position(), this.m_point_end.ask_position(), d_next_axis);
		//回転軸と回転量。
		double[] rot_axis_angle = new double[4];
		mathmatic.Mathmatic.calc_rotate_axis_for_matching_vector(def_d_init_axis, d_next_axis, rot_axis_angle);
		//Rotateオブジェクト作成
