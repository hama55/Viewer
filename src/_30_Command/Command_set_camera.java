...
public class Command_set_camera 
//	extends Command_Imp
	implements
		Entity_Imp,
		Command_Imp,
...
//	Main_Frame			m_mainframe	= null;
	//PopupMenu_TreeNode	m_popup		= null;
//	Object_Camera		m_camera	= null;
...
//			//cameraを取得
//	//		Object_Camera camera = (Object_Camera) object_Group.get_object();
//			Object_Camera camera = (Object_Camera) object_Group.ask_ObjectByIndex(0);
			//OpenGL_Playからビューを取得し、cameraを上書き
//			this.m_mainframe.get_OpenGL_Play().get_view(0).get_Camera().set_camera(camera);
...
//			}
//			
//			this.m_mainframe.get_OpenGL_Play().get_view(0).get_Camera().set_camera(m_camera);
//			//再描画
//			this.m_mainframe.get_OpenGL_Play().redisplay();
			return "正常終了";
		}
		catch (Exception ex)
		{
	...
	*	@version
	***************************************************************************/
	@Override public Command_Imp	factory() {return new Command_set_camera();}
