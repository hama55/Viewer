...
public class Command_save_file
//	extends Command_Imp
	implements
		Entity_Imp,
		Command_Imp,
...
//	Main_Frame			m_mainFrame;
	ArrayList<String>	m_arryFilePaths;
...
//				
//				//ファイルを渡す
//				this.m_mainFrame.file_save(arryFiles.get(0));
				return "正常終了";
			}
		}
		catch (Exception ex)
	...
	*	@version
	***************************************************************************/
	@Override public Command_Imp	factory() {return new Command_save_file(null);}
